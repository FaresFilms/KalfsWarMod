...
import net.kalf.kalfswarmod.entity.custom.LargeBulletProjectileEntity;
...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<LargeBulletProjectileEntity>> LARGE_BULLET_PROJECTILE =
            ENTITY_TYPES.register("large_bullet_projectile", () -> EntityType.Builder.<LargeBulletProjectileEntity>of(LargeBulletProjectileEntity::new, MobCategory.MISC)
                    .sized(0.7f, 0.7f).build("large_bullet_projectile"));
